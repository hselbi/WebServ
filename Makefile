...
SRCS			= ./main.cpp \
					...
					$(addprefix $(SRC_RESPONSE)/, Response.cpp ResponseError.cpp ResponseGetters.cpp Utils.cpp ResponseMethods.cpp ResponseReader.cpp ResponseUtils.cpp ResponseSetters.cpp)
